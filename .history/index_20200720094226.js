...
document.addEventListener('keypress', (keyPressed) => {
    ...
    switch (key) {
        case keys[0].id:
            ...
            keys[0].style.border = 'thick solid red'
            break
        case keys[1].id:
            new Audio('./keys/S.mp3').play()
            keys[1].style.border = 'thick solid red'
            break
        case keys[2].id:
            new Audio('./keys/D.mp3').play()
            keys[2].style.border = 'thick solid red'
            break
        case keys[3].id:
            new Audio('./keys/F.mp3').play()
            keys[3].style.border = 'thick solid red'
            break
        case keys[4].id:
            new Audio('./keys/G.mp3').play()
            keys[4].style.border = 'thick solid red'
            break
        case keys[5].id:
            new Audio('./keys/H.mp3').play()
            keys[5].style.border = 'thick solid red'
            break
        case keys[6].id:
            new Audio('./keys/J.mp3').play()
            keys[6].style.border = 'thick solid red'
            break
        case keys[7].id:
            new Audio('./keys/W.mp3').play()
            keys[7].style.border = 'thick solid red'
            break
        case keys[8].id:
            new Audio('./keys/E.mp3').play()
            keys[8].style.border = 'thick solid red'
            break
        case keys[9].id:
            new Audio('./keys/T.mp3').play()
            keys[9].style.border = 'thick solid red'
            break
        case keys[10].id:
            new Audio('./keys/Y.mp3').play()
            keys[10].style.border = 'thick solid red'
            break
        case keys[11].id:
            new Audio('./keys/U.mp3').play()
            keys[11].style.border = 'thick solid red'
            break
        default:
...
document.addEventListener('keyup', (event) => {
    const key = document.getElementById('${event.')
})
